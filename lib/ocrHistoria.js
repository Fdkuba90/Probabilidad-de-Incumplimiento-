// lib/ocrHistoria.js — OCR del bloque "Historia:" (Vercel friendly, sin worker externo)
import { createWorker } from "tesseract.js";
import { createCanvas } from "@napi-rs/canvas";
// Import ESM "legacy" de pdfjs-dist, que funciona en Node sin worker separado
import * as pdfjs from "pdfjs-dist/legacy/build/pdf.mjs";

// En Node no usamos worker aparte
...
export async function ocrHistoriaFromPdf(buffer) {
  // Cargamos el PDF y renderizamos algunas páginas (1..6) a imagen
  ...
  const worker = await createWorker("spa"); // tesseract.js v5 API simple
  // Nota: no establecemos whitelist estricta; Tesseract en español funciona bien con números y texto.
