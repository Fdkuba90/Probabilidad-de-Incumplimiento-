...
// Extrae "Historia por mes (pesos)" por OCR usando @napi-rs/canvas + pdfjs-dist + tesseract.js

import { createCanvas } from "@napi-rs/canvas";
import * as pdfjs from "pdfjs-dist";
import Tesseract from "tesseract.js";

// En Node no necesitamos worker separado (v4 lo maneja internamente)
...
class NapiCanvasFactory {
  ...
  destroy(canvasAndContext) {
    ...
    // @napi-rs/canvas no requiere más limpieza
  }
}
